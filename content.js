      ...
      for (const m of mutations) {
        if (m.type === 'childList') {
          ...
          if (parent && parent.closest) {
            if (parent.closest('div[data-message-id], user-query, model-response, .agent-chat__list__item, [data-virtual-list-item-key], .chat-content-item, section[data-turn], [data-message-author-role]')) {
              hasNew = true;
            }
          }
        }
